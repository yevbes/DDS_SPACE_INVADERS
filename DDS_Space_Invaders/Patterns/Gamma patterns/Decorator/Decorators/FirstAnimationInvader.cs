...
{
    class FirstAnimationInvader : InvaderDecorator
    {
        ...
        private void createInvaderBitmapArray()
        {
            ...
            switch (inv.InvaderType)
            {
                ...
                case ShipType.Satellite:
                    ...
                    imageArray[1] = Properties.Resources.satellite1;
                    imageArray[2] = Properties.Resources.satellite1;
                    imageArray[3] = Properties.Resources.satellite1;
                    break;
                ...
                case ShipType.Star:
                    ...
                    imageArray[1] = Properties.Resources.star1;
                    imageArray[2] = Properties.Resources.star1;
                    imageArray[3] = Properties.Resources.star1;
                    break;
            }
        }
    }
